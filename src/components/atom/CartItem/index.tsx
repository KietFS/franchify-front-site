...
const CartItem: React.FC<CartItemProps> = ({ cartItem }) => {
  ...
  return (
    <div
      ...
      className="flex w-full justify-between items-center px-8 py-4 border-gray-200 rounded-lg border cursor-pointer"
    >
      ...
      <div className="">
        <h2 className="text-lg font-semibold text-gray-800 max-w-2/3 w-2/3">
          {name}
        </h2>
        ...
        <div className="flex items-center mt-2">
          {loading ? (
            ...
            <>
              {currentQuantity > 1 ? (
                <IconButton
                  className="px-2 py-1 border-gray-300 rounded-l-lg"
